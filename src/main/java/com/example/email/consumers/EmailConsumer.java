...
import com.example.email.dtos.EmailFormat;
...
public class EmailConsumer {
    ...
    private void sendActualEmail(EmailFormat emailMessage) {
        ...
        final String fromEmail = emailMessage.getFrom(); //requires valid gmail id
        final String password = "pxuviyhfqbdddoncnki"; // correct password for gmail id
        final String toEmail = emailMessage.getTo(); // can be any email id
